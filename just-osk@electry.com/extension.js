/*
 * Just OSK - On-Screen Keyboard that just works
 * Based on various OSK implementations but remastered
 * by @electriczity for multi-session support (user + GDM + lock screen)
 */
